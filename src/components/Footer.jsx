      ...
      <footer>
        <div className="insideFooter">
          <div className="footerWidgets"> 
            ...
            <p className="footer-para">At Muskan Bakery, we’re passionate about delivering fresh, delicious, and high-quality bakery products straight from our ovens to your table. This is the perfect place for all things bakery!</p>
          </div>

          <div className="footerWidgets">
            <h3 className="montserrat">Quick Links</h3>
            <a className="manrope" href="index-3.html">Home</a>
            <a className="manrope" href="cookies.html">Our Products</a>
            <a className="manrope" href="festive-gifting-2.html">Gifting</a>
            <a className="manrope" href="about-2.html">About Us</a>
          ...
          <div className="footerWidgets">
            ...
            <div className="footerIcons">
              ...
              <h3 style={{ backgroundColor: '#3b5998' }}><FaFacebook /></h3></a>
              ...
              <h3 style={{ color: 'black',backgroundColor:'white',borderRadius:'50%' }}><FaInstagramSquare /></h3> </a>

              <h3 style={{ backgroundColor: '#cd201f' }}><FaYoutube /></h3> </div>

            <h3 className="montserrat">Find Us On</h3>

            <div className="footerIcons">
              <h3 style={{ color: 'black',backgroundColor:'white',borderRadius:'50%' }}><FaAmazon /></h3>
              <img src={amazonQr} style={{ height: '90px' }} /> </div>
          </div>
